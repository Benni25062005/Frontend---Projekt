...
export default function Login() {
  ...
  localStorage.setItem('password', hashedPassword);
    ...
    return(<>
        <h2 class="text-center text-3xl mt-10 bg-slate-200 rounded-xl mx-auto h-10 w-1/3">Login</h2>
        <div class="flex flex-col items-center mt-8 w-1/3 mx-auto h-80 bg-slate-100 rounded-xl shadow-lg   ">
